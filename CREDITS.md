...
- **Alexandra Papoutsaki** - Creator and lead researcher
- **Aaron Gokaslan** - Core developer
- **Jeff Huang** - Project maintainer
- **James Tompkin** - Research advisor

### Research Support

- NSF Grants IIS-1464061 and IIS-1552663
...
- SearchGazer (CHIIR 2017) - Remote web search studies
- The Eye of the Typer (ETRA 2018) - Gaze behavior during typing

Full list: https://webgazer.cs.brown.edu/#publications
...
- TensorFlow.js 4.x with MediaPipe FaceMesh
