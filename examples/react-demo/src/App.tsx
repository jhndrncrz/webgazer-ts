 ...
 * Calibration starts automatically when you begin() - no manual setup needed!
 */
...
export default function App() {
  ...
  // Note: Calibration starts automatically when you call start()!
  // No need to manually call addMouseEventListeners() - it's done in begin()

  return (
    <div style={styles.container}>
      <header style={styles.header}>
        <h1 style={styles.title}>👁️ Webgazer React Demo</h1>
        <p style={styles.subtitle}>Automatic Calibration - No Setup Required!</p>
      </header>
      ...
      <div style={styles.infoBox}>
        ...
        <p>
          <strong>Calibration starts automatically!</strong> When you click "Start Tracking",
          Webgazer automatically begins learning from your clicks. No manual setup needed!
        </p>
        <ol style={styles.instructions}>
          <li>Click "Start Tracking" to begin (calibration starts automatically)</li>
        ...
        <p style={{marginTop: '15px', fontSize: '0.9rem', opacity: 0.8}}>
          <em>This matches the original Webgazer.js behavior - begin() automatically enables calibration.</em>
        </p>
      </div>
        ...
        <>
          <div style={styles.calibrationPrompt}>
            ...
            <p style={{fontSize: '0.9rem', marginTop: '10px', opacity: 0.9}}>
              Calibration started automatically - every click makes predictions more accurate!
            </p>
          </div>
      ...
      <footer style={styles.footer}>
        ...
        <p>Calibration is automatic - matches original Webgazer API!</p>
      </footer>
    </div>
  );
}
